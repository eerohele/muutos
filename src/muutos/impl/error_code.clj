(ns ^:no-doc muutos.impl.error-code)

(def condition-name
  "A map of SQL state error code to keyword describing the error."
  {"00000" :successful-completion
   ...
   "22008" :ERRCODE-DATETIME-VALUE-OUT-OF-RANGE
   ...
   "26000" :ERRCODE-UNDEFINED-PSTATEMENT
   ...
   "34000" :ERRCODE-UNDEFINED-CURSOR
   ...
   "3D000" :ERRCODE-UNDEFINED-DATABASE
   "3F000" :ERRCODE-UNDEFINED-SCHEMA
